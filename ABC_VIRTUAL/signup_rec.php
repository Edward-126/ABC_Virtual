...
<body class="d-flex align-items-center py-4">
    ...
    if (isset($_POST['btn-submit'])) {
        ...
        $UA_position = $_POST["txt-ua-position"];
        ...
        VALUES ('$UA_firstname', '$UA_username', '$UA_password', 'receptionist')";

        if (mysqli_query($connection, $sql)) {
            $user_id = mysqli_insert_id($connection);

            $sql2 = "INSERT INTO reception_accounts (
                ra_firstname, ra_lastname, ra_age, ra_gender, ra_position, ra_username, ra_password, ra_email, ra_contact, ra_address, ra_province, ra_district, ra_zip, users_u_ID) 
            VALUES ('$UA_firstname', '$UA_lastname', '$UA_age', '$UA_gender', '$UA_position', '$UA_username', '$UA_password', '$UA_email', '$UA_contact', '$UA_address', '$UA_province', '$UA_district', '$UA_zip', '$user_id')";

            if (mysqli_query($connection, $sql2)) {
                $sql3 = "INSERT INTO receptionists (r_firstname, r_lastname, r_position, r_contact, users_u_ID) 
                    VALUES ('$UA_firstname', '$UA_lastname', '$UA_position',  '$UA_contact', '$user_id')";
    ...
    <div class="container d-flex align-items-center py-4">
        ...
        <form class="sign-up m-auto" method="POST">
            ...
            <h1 class="h3 mb-3 fw-normal">Sign Up (Receptionist)</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="Position" name="txt-ua-position">
                </div>
