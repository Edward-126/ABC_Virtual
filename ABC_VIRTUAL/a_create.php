...
<body class="d-flex align-items-center py-4">
    ...
    $logged_in_user_id = $_SESSION['s_u_ID'];
    $query_patient = "SELECT p_firstname, p_lastname FROM patients WHERE users_u_ID = $logged_in_user_id";
        ...
        <form class="sign-up m-auto" method="POST">
            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="firstName" placeholder="" value="<?php echo $row_patient['p_firstname']; ?>" required name="txt-a-firstname">
                </div>

                <div class="col-sm-6">
                    <label class="form-label">Last name</label>
                    <input type="text" class="form-control" id="lastName" placeholder="" value="<?php echo $row_patient['p_lastname']; ?>" required name="txt-a-lastname">
                </div>
    ...
    if (isset($_POST['btn-submit'])) {
        ...
        $query_patient_id = "SELECT p_ID FROM patients WHERE p_firstname = '$P_FirstName' AND p_lastname = '$P_LastName'";
        $result_patient_id = mysqli_query($connection, $query_patient_id);
        $row_patient_id = mysqli_fetch_assoc($result_patient_id);
        $patient_id = $row_patient_id['p_ID'];

        $sql = "INSERT INTO appointments (a_date, a_reason, patients_p_ID, doctors_d_ID) VALUES ('$P_AppointmentDate', '$P_Reason', $patient_id, $doctor_id)";
