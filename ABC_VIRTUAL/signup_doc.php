...
<body class="d-flex align-items-center py-4">
    ...
    if (isset($_POST['btn-submit'])) {
        ...
        $UA_specialization = $_POST["txt-ua-special"];
        ...
        VALUES ('$UA_firstname', '$UA_username', '$UA_password', 'doctor')";

        if (mysqli_query($connection, $sql)) {
            $user_id = mysqli_insert_id($connection);

            $sql2 = "INSERT INTO doctor_accounts (
                da_firstname, da_lastname, da_age, da_gender, da_specialization, da_username, da_password, da_email, da_contact, da_address, da_province, da_district, da_zip, users_u_ID) 
            VALUES ('$UA_firstname', '$UA_lastname', '$UA_age', '$UA_gender', '$UA_specialization', '$UA_username', '$UA_password', '$UA_email', '$UA_contact', '$UA_address', '$UA_province', '$UA_district', '$UA_zip', '$user_id')";

            if (mysqli_query($connection, $sql2)) {
                $sql3 = "INSERT INTO doctors (d_firstname, d_lastname, d_specialization, d_contact, users_u_ID) 
                    VALUES ('$UA_firstname', '$UA_lastname', '$UA_specialization',  '$UA_contact', '$user_id')";
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        setTimeout(function () {
                            myModal.hide();
                            window.location.href = "aa_home.php";
                        }, 2500);
                    });
                </script>
            HTML;
    ...
    <div class="container d-flex align-items-center py-4">
        ...
        <form class="sign-up m-auto" method="POST">
            ...
            <h1 class="h3 mb-3 fw-normal">Sign Up (Doctor)</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="age" placeholder="Age" value="" required name="txt-ua-age">
                </div>
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="Specialization" name="txt-ua-special">
                </div>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="same-address">Data Insert By Admin</label>
                </div>
